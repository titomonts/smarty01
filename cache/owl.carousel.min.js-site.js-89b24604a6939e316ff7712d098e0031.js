...
This dump has been created from the following files:
    - <root>/resources/theylangylang/owlcarousel/owl.carousel.min.js
...
if($(window).height()<600){$('.modal-box .modal-body').css('max-height',$(window).height()*.9);}else{$('.modal-box .modal-body').removeAttr('style');}});setTimeout(function(){$(window).trigger('resize');},1000);$('.toggler').bind('click',function(event){event.preventDefault();$(this).toggleClass('active');$('.nav').toggleClass('open');});$('html').bind('click',function(e){if($(window).width()<768){if($(e.target).is('.nav li, .nav li a, .toggler, .toggler *')){return true;}
...
if($('.gallery-container').size()){$('body').append('<div class="popup-container"><span class="close"><i class="fa fa-times" aria-hidden="true"></i></span><ul class="owl-carousel"></ul></div>');$('.gallery-container li').each(function(){var imgurl=$(this).find('a').attr('href');var imgalt=$(this).find('img').attr('alt');$('.popup-container .owl-carousel').append('<li><div class="loader"><i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i></div><img data-src="'+imgurl+'" alt="'+imgalt+'" class="lazyload" /><span class="caption">'+imgalt+'</span></li>')});$('.popup-container .owl-carousel').owlCarousel({autoPlay:false,navigation:true,navigationText:['<i class="fa fa-chevron-left" aria-hidden="true"></i>','<i class="fa fa-chevron-right" aria-hidden="true"></i>'],paginationSpeed:1000,goToFirstSpeed:2000,singleItem:true,transitionStyle:'fade'});$('.gallery-container li').bind('click',function(e){e.preventDefault();var owlpopup=$(".popup-container .owl-carousel").data('owlCarousel');owlpopup.goTo($(this).index());$('.popup-container').fadeIn();});$('.popup-container').bind('click',function(e){e.preventDefault();if($(e.target).is('span, i, img, .owl-prev, .owl-next')){return true;}
$('.popup-container').fadeOut();});$('.popup-container .close').bind('click',function(e){e.preventDefault();$('.popup-container').fadeOut();});var lim=12;var len=$('.gallery-container li').length;$('.gallery-container li:gt('+(lim-1)+')').hide();var totalPage=Math.round(len/lim);$('.gallery-pagination').append('<a href="javascript:void(0);" class="prev"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a>');for(var i=1;i<=totalPage;i++){$('.gallery-pagination').append('<a href="javascript:void(0);" class="page">'+i+'</a>');}
$('.gallery-pagination').append('<a href="javascript:void(0);" class="next"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a>');$('.gallery-pagination a.page:first').addClass('active');$('.gallery-pagination a.prev').css({'opacity':0,'visibility':'hidden'});$('.gallery-pagination a.page').click(function(){var index=$(this).index();var gt=lim*index;$('.gallery-pagination a.page').removeClass('active');$(this).addClass('active');$('.gallery-container li').slideUp();for(var i=gt-lim;i<gt;i++){$('.gallery-container li:eq('+i+')').slideDown();}});$('.gallery-pagination a.prev').click(function(){var index=$('.gallery-pagination a.page.active').index()-2;var gt=lim*(index+1);$('.gallery-pagination a.page').removeClass('active');$('.gallery-pagination a.page:eq('+index+')').addClass('active');$('.gallery-container li').slideUp();for(var i=gt-lim;i<gt;i++){$('.gallery-container li:eq('+i+')').slideDown();}});$('.gallery-pagination a.next').click(function(){var index=$('.gallery-pagination a.page.active').index();var gt=lim*(index+1);$('.gallery-pagination a.page').removeClass('active');$('.gallery-pagination a.page:eq('+index+')').addClass('active');$('.gallery-container li').slideUp();for(var i=gt-lim;i<gt;i++){$('.gallery-container li:eq('+i+')').slideDown();}});$('.gallery-pagination a').click(function(){if($('.gallery-pagination a.page:first').hasClass('active')){$('.gallery-pagination a.prev').css({'opacity':0,'visibility':'hidden'});}else{$('.gallery-pagination a.prev').removeAttr('style');}
if($('.gallery-pagination a.page:last').hasClass('active')){$('.gallery-pagination a.next').css({'opacity':0,'visibility':'hidden'});}else{$('.gallery-pagination a.next').removeAttr('style');}});}
$(document).ready(function(){var bookingbar=$('#header-enquire').offset().top-$('.header').outerHeight()-parseInt($('.header').css('margin-top'));$(window).scroll(function(){var currentScroll=$(window).scrollTop();if(currentScroll>=bookingbar){$('#header-enquire').css({position:'fixed',top:$('.header').outerHeight()+parseInt($('.header').css('margin-top'))});}else{$('#header-enquire').css({position:'relative',top:0});}});});$('.tabs ul').each(function(){var first_tab_id=$(this).children('li:first a').attr('href');$(this).children('li:first').addClass('current');$(this).siblings('div:first').addClass('current');});$('.tabs > ul li a').bind('click',function(e){e.preventDefault();var tab_id=$(this).attr('href');$(this).closest('ul').find('li').removeClass('current');$(this).closest('.tabs').children('div').removeClass('current');$(this).closest('li').addClass('current');$(this).closest('.tabs').find(tab_id).addClass('current');});$('body').append('<div class="modal-overlay js-modal-close" style="display: none;"></div><div id="popup" class="modal-box"><header><a href="#" class="js-modal-close close">×</a></header><div class="modal-body"></div></div>');$('[data-dialog]').bind('click',function(e){e.preventDefault();$(".modal-overlay").fadeTo(500,0.7);$('#popup .modal-body').load($(this).attr('data-dialog'));$('#popup').fadeIn();});$(".js-modal-close, .modal-overlay").bind('click',function(e){e.preventDefault();$(".modal-box, .modal-overlay").fadeOut(500);});$('[data-popover]').bind('mouseover',function(){var drct=$(this).attr('data-popover-direction');var ths=$(this);if(!$('.popover').size())$('body').append('<div class="popover" />');$('.popover').html(ths.attr('data-popover')).addClass('hover');switch(drct){case'bottom':$('.popover').addClass('bottom').css({top:ths.offset().top+((ths.outerHeight()+10)+$('.popover').outerHeight()),left:ths.offset().left+(ths.outerWidth()/2)});break;default:$('.popover').removeClass('bottom').css({top:ths.offset().top-(ths.outerHeight()/2),left:ths.offset().left+(ths.outerWidth()/2)});break;}});$('[data-popover]').bind('mouseleave',function(){$('.popover').removeClass('hover').removeAttr('style');});$('#opener').bind('click',function(e){e.preventDefault();$(".modal-overlay").fadeTo(500,0.7);$('#popup .modal-body').html($('#dialog').html());$('#popup').fadeIn();});$(".js-modal-close, .modal-overlay").bind('click',function(e){e.preventDefault();$(".modal-box, .modal-overlay").fadeOut(500);});if($('#map_div').size()){initialize_map('map_div','/ketewel-bali.html',[{"featureType":"poi","elementType":"labels","stylers":[{"visibility":"off"}]}]);}
